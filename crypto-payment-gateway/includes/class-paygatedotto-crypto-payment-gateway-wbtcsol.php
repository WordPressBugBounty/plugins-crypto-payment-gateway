...
protected $wbtcsol_tolerance_percentage;
protected $icon_url;
    ...
    public function __construct() {
		...
		$this->wbtcsol_tolerance_percentage = sanitize_text_field($this->get_option('wbtcsol_tolerance_percentage'));
    ...
    public function init_form_fields() {
        $this->form_fields = array(
            ...
            'wbtcsol_tolerance_percentage' => array(
    ...
    public function process_payment($order_id) {
		...
		$paygatedottocryptogateway_wbtcsol_tolerance_percentage = $this->wbtcsol_tolerance_percentage;
...
if ($paygatedottocryptogateway_wbtcsol_genqrcode_conversion_resp && isset($paygatedottocryptogateway_wbtcsol_genqrcode_conversion_resp['qr_code'])) {
	...
	$order->add_meta_data('paygatedotto_wbtcsol_tolerance_percentage', $paygatedottocryptogateway_wbtcsol_tolerance_percentage, true);
...
function paygatedottocryptogateway_add_instant_payment_gateway_wbtcsol($gateways) {
    $gateways[] = 'PayGateDotTo_Crypto_Payment_Gateway_Wbtcsol';
    return $gateways;
}
add_filter('woocommerce_payment_gateways', 'paygatedottocryptogateway_add_instant_payment_gateway_wbtcsol');
}
...
function paygatedottocryptogateway_wbtcsol_change_order_status_callback( $request ) {
	...
	$paygatedottocryptogateway_wbtcsolexpected_amount = $order->get_meta('paygatedotto_wbtcsol_payin_amount', true) * $order->get_meta('paygatedotto_wbtcsol_tolerance_percentage', true);
