...
protected $pepearbitrum_tolerance_percentage;
protected $icon_url;
    ...
    public function __construct() {
		...
		$this->pepearbitrum_tolerance_percentage = sanitize_text_field($this->get_option('pepearbitrum_tolerance_percentage'));
    ...
    public function init_form_fields() {
        $this->form_fields = array(
            ...
            'pepearbitrum_tolerance_percentage' => array(
    ...
    public function process_payment($order_id) {
		...
		$paygatedottocryptogateway_pepearbitrum_tolerance_percentage = $this->pepearbitrum_tolerance_percentage;
...
if ($paygatedottocryptogateway_pepearbitrum_genqrcode_conversion_resp && isset($paygatedottocryptogateway_pepearbitrum_genqrcode_conversion_resp['qr_code'])) {
	...
	$order->add_meta_data('paygatedotto_pepearbitrum_tolerance_percentage', $paygatedottocryptogateway_pepearbitrum_tolerance_percentage, true);
...
function paygatedottocryptogateway_add_instant_payment_gateway_pepearbitrum($gateways) {
    $gateways[] = 'PayGateDotTo_Crypto_Payment_Gateway_Pepearbitrum';
    return $gateways;
}
add_filter('woocommerce_payment_gateways', 'paygatedottocryptogateway_add_instant_payment_gateway_pepearbitrum');
}
...
function paygatedottocryptogateway_pepearbitrum_change_order_status_callback( $request ) {
	...
	$paygatedottocryptogateway_pepearbitrumexpected_amount = $order->get_meta('paygatedotto_pepearbitrum_payin_amount', true) * $order->get_meta('paygatedotto_pepearbitrum_tolerance_percentage', true);
