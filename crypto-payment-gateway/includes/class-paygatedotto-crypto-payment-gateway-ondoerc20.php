...
$paygatedottocryptogateway_ondoerc20_response = wp_remote_get('https://api.paygate.to/crypto/erc20/ondo/convert.php?value=' . $paygatedottocryptogateway_ondoerc20_total . '&from=' . strtolower($paygatedottocryptogateway_ondoerc20_currency), array('timeout' => 30));
...
if ($paygatedottocryptogateway_ondoerc20_conversion_resp && isset($paygatedottocryptogateway_ondoerc20_conversion_resp['value_coin'])) {
    ...
    return null;
		...
		$paygatedottocryptogateway_ondoerc20_feesest_response = wp_remote_get('https://api.paygate.to/crypto/erc20/ondo/fees.php', array('timeout' => 30));
...
$paygatedottocryptogateway_ondoerc20_revfeesest_response = wp_remote_get('https://api.paygate.to/crypto/erc20/ondo/convert.php?value=' . $paygatedottocryptogateway_ondoerc20_feesest_reference_total . '&from=usd', array('timeout' => 30));
...
$paygatedottocryptogateway_ondoerc20_response_minimum = wp_remote_get('https://api.paygate.to/crypto/erc20/ondo/info.php', array('timeout' => 30));
...
$paygatedottocryptogateway_ondoerc20_gen_wallet = wp_remote_get('https://api.paygate.to/crypto/erc20/ondo/wallet.php?address=' . $this->ondoerc20_wallet_address .'&callback=' . urlencode($paygatedottocryptogateway_ondoerc20_callback), array('timeout' => 30));
...
if (is_wp_error($paygatedottocryptogateway_ondoerc20_gen_wallet)) {
 ...
 // Check if decoding was successful
    if ($paygatedottocryptogateway_ondoerc20_wallet_decbody && isset($paygatedottocryptogateway_ondoerc20_wallet_decbody['address_in'])) {
		...
		$paygatedottocryptogateway_ondoerc20_genqrcode_response = wp_remote_get('https://api.paygate.to/crypto/erc20/ondo/qrcode.php?address=' . $paygatedottocryptogateway_ondoerc20_gen_addressIn, array('timeout' => 30));
