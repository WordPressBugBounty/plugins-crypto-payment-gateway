...
protected $icon_url;
    ...
    public function process_payment($order_id) {
		...
		$paygatedottocryptogateway_bch_tolerance_percentage = $this->bch_tolerance_percentage;
...
if ($paygatedottocryptogateway_bch_genqrcode_conversion_resp && isset($paygatedottocryptogateway_bch_genqrcode_conversion_resp['qr_code'])) {
	...
	$order->add_meta_data('paygatedotto_bch_tolerance_percentage', $paygatedottocryptogateway_bch_tolerance_percentage, true);
...
function paygatedottocryptogateway_bch_change_order_status_callback( $request ) {
	...
	$paygatedottocryptogateway_bchexpected_amount = $order->get_meta('paygatedotto_bch_payin_amount', true) * $order->get_meta('paygatedotto_bch_tolerance_percentage', true);
