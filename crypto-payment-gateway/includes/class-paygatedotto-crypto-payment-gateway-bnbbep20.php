...
protected $bnbbep20_tolerance_percentage;
protected $icon_url;
    ...
    public function __construct() {
		...
		$this->bnbbep20_tolerance_percentage = sanitize_text_field($this->get_option('bnbbep20_tolerance_percentage'));
    ...
    public function init_form_fields() {
        $this->form_fields = array(
            ...
            'bnbbep20_tolerance_percentage' => array(
    ...
    public function process_payment($order_id) {
		...
		$paygatedottocryptogateway_bnbbep20_tolerance_percentage = $this->bnbbep20_tolerance_percentage;
...
if ($paygatedottocryptogateway_bnbbep20_genqrcode_conversion_resp && isset($paygatedottocryptogateway_bnbbep20_genqrcode_conversion_resp['qr_code'])) {
	...
	$order->add_meta_data('paygatedotto_bnbbep20_tolerance_percentage', $paygatedottocryptogateway_bnbbep20_tolerance_percentage, true);
...
function paygatedottocryptogateway_add_instant_payment_gateway_bnbbep20($gateways) {
    $gateways[] = 'PayGateDotTo_Crypto_Payment_Gateway_Bnbbep20';
    return $gateways;
}
add_filter('woocommerce_payment_gateways', 'paygatedottocryptogateway_add_instant_payment_gateway_bnbbep20');
}
...
function paygatedottocryptogateway_bnbbep20_change_order_status_callback( $request ) {
	...
	$paygatedottocryptogateway_bnbbep20expected_amount = $order->get_meta('paygatedotto_bnbbep20_payin_amount', true) * $order->get_meta('paygatedotto_bnbbep20_tolerance_percentage', true);
