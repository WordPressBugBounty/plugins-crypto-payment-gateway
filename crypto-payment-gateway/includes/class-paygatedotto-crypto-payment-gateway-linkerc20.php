...
protected $linkerc20_tolerance_percentage;
protected $icon_url;
    ...
    public function __construct() {
		...
		$this->linkerc20_tolerance_percentage = sanitize_text_field($this->get_option('linkerc20_tolerance_percentage'));
    ...
    public function init_form_fields() {
        $this->form_fields = array(
            ...
            'linkerc20_tolerance_percentage' => array(
    ...
    public function process_payment($order_id) {
		...
		$paygatedottocryptogateway_linkerc20_tolerance_percentage = $this->linkerc20_tolerance_percentage;
...
if ($paygatedottocryptogateway_linkerc20_genqrcode_conversion_resp && isset($paygatedottocryptogateway_linkerc20_genqrcode_conversion_resp['qr_code'])) {
	...
	$order->add_meta_data('paygatedotto_linkerc20_tolerance_percentage', $paygatedottocryptogateway_linkerc20_tolerance_percentage, true);
...
function paygatedottocryptogateway_add_instant_payment_gateway_linkerc20($gateways) {
    $gateways[] = 'PayGateDotTo_Crypto_Payment_Gateway_Linkerc20';
    return $gateways;
}
add_filter('woocommerce_payment_gateways', 'paygatedottocryptogateway_add_instant_payment_gateway_linkerc20');
}
...
function paygatedottocryptogateway_linkerc20_change_order_status_callback( $request ) {
	...
	$paygatedottocryptogateway_linkerc20expected_amount = $order->get_meta('paygatedotto_linkerc20_payin_amount', true) * $order->get_meta('paygatedotto_linkerc20_tolerance_percentage', true);
