...
protected $wethpolygon_tolerance_percentage;
protected $icon_url;
    ...
    public function __construct() {
		...
		$this->wethpolygon_tolerance_percentage = sanitize_text_field($this->get_option('wethpolygon_tolerance_percentage'));
    ...
    public function init_form_fields() {
        $this->form_fields = array(
            ...
            'wethpolygon_tolerance_percentage' => array(
    ...
    public function process_payment($order_id) {
		...
		$paygatedottocryptogateway_wethpolygon_tolerance_percentage = $this->wethpolygon_tolerance_percentage;
...
if ($paygatedottocryptogateway_wethpolygon_genqrcode_conversion_resp && isset($paygatedottocryptogateway_wethpolygon_genqrcode_conversion_resp['qr_code'])) {
	...
	$order->add_meta_data('paygatedotto_wethpolygon_tolerance_percentage', $paygatedottocryptogateway_wethpolygon_tolerance_percentage, true);
...
function paygatedottocryptogateway_add_instant_payment_gateway_wethpolygon($gateways) {
    $gateways[] = 'PayGateDotTo_Crypto_Payment_Gateway_Wethpolygon';
    return $gateways;
}
add_filter('woocommerce_payment_gateways', 'paygatedottocryptogateway_add_instant_payment_gateway_wethpolygon');
}
...
function paygatedottocryptogateway_wethpolygon_change_order_status_callback( $request ) {
	...
	$paygatedottocryptogateway_wethpolygonexpected_amount = $order->get_meta('paygatedotto_wethpolygon_payin_amount', true) * $order->get_meta('paygatedotto_wethpolygon_tolerance_percentage', true);
