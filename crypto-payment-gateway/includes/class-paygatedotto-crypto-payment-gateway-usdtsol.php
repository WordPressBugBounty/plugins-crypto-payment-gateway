...
function paygatedottocryptogateway_add_instant_payment_gateway_usdtsol($gateways) {
    $gateways[] = 'PayGateDotTo_Crypto_Payment_Gateway_Usdtsol';
    return $gateways;
}
add_filter('woocommerce_payment_gateways', 'paygatedottocryptogateway_add_instant_payment_gateway_usdtsol');
}
