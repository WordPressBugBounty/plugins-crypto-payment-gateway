...
protected $usdcavaxc_tolerance_percentage;
protected $icon_url;
    ...
    public function __construct() {
		...
		$this->usdcavaxc_tolerance_percentage = sanitize_text_field($this->get_option('usdcavaxc_tolerance_percentage'));
    ...
    public function init_form_fields() {
        $this->form_fields = array(
            ...
            'usdcavaxc_tolerance_percentage' => array(
    ...
    public function process_payment($order_id) {
		...
		$paygatedottocryptogateway_usdcavaxc_tolerance_percentage = $this->usdcavaxc_tolerance_percentage;
...
if ($paygatedottocryptogateway_usdcavaxc_genqrcode_conversion_resp && isset($paygatedottocryptogateway_usdcavaxc_genqrcode_conversion_resp['qr_code'])) {
	...
	$order->add_meta_data('paygatedotto_usdcavaxc_tolerance_percentage', $paygatedottocryptogateway_usdcavaxc_tolerance_percentage, true);
...
function paygatedottocryptogateway_add_instant_payment_gateway_usdcavaxc($gateways) {
    $gateways[] = 'PayGateDotTo_Crypto_Payment_Gateway_Usdcavaxc';
    return $gateways;
}
add_filter('woocommerce_payment_gateways', 'paygatedottocryptogateway_add_instant_payment_gateway_usdcavaxc');
}
...
function paygatedottocryptogateway_usdcavaxc_change_order_status_callback( $request ) {
	...
	$paygatedottocryptogateway_usdcavaxcexpected_amount = $order->get_meta('paygatedotto_usdcavaxc_payin_amount', true) * $order->get_meta('paygatedotto_usdcavaxc_tolerance_percentage', true);
