...
$paygatedottocryptogateway_cbbtcbase_response = wp_remote_get('https://api.paygate.to/crypto/base/cbbtc/convert.php?value=' . $paygatedottocryptogateway_cbbtcbase_total . '&from=' . strtolower($paygatedottocryptogateway_cbbtcbase_currency), array('timeout' => 30));
...
if ($paygatedottocryptogateway_cbbtcbase_conversion_resp && isset($paygatedottocryptogateway_cbbtcbase_conversion_resp['value_coin'])) {
    ...
    return null;
		...
		$paygatedottocryptogateway_cbbtcbase_feesest_response = wp_remote_get('https://api.paygate.to/crypto/base/cbbtc/fees.php', array('timeout' => 30));
...
$paygatedottocryptogateway_cbbtcbase_revfeesest_response = wp_remote_get('https://api.paygate.to/crypto/base/cbbtc/convert.php?value=' . $paygatedottocryptogateway_cbbtcbase_feesest_reference_total . '&from=usd', array('timeout' => 30));
...
$paygatedottocryptogateway_cbbtcbase_response_minimum = wp_remote_get('https://api.paygate.to/crypto/base/cbbtc/info.php', array('timeout' => 30));
...
$paygatedottocryptogateway_cbbtcbase_gen_wallet = wp_remote_get('https://api.paygate.to/crypto/base/cbbtc/wallet.php?address=' . $this->cbbtcbase_wallet_address .'&callback=' . urlencode($paygatedottocryptogateway_cbbtcbase_callback), array('timeout' => 30));
...
if (is_wp_error($paygatedottocryptogateway_cbbtcbase_gen_wallet)) {
 ...
 // Check if decoding was successful
    if ($paygatedottocryptogateway_cbbtcbase_wallet_decbody && isset($paygatedottocryptogateway_cbbtcbase_wallet_decbody['address_in'])) {
		...
		$paygatedottocryptogateway_cbbtcbase_genqrcode_response = wp_remote_get('https://api.paygate.to/crypto/base/cbbtc/qrcode.php?address=' . $paygatedottocryptogateway_cbbtcbase_gen_addressIn, array('timeout' => 30));
