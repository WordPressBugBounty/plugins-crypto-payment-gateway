...
protected $usdtpolygon_tolerance_percentage;
protected $icon_url;
    ...
    public function __construct() {
		...
		$this->usdtpolygon_tolerance_percentage = sanitize_text_field($this->get_option('usdtpolygon_tolerance_percentage'));
    ...
    public function init_form_fields() {
        $this->form_fields = array(
            ...
            'usdtpolygon_tolerance_percentage' => array(
    ...
    public function process_payment($order_id) {
		...
		$paygatedottocryptogateway_usdtpolygon_tolerance_percentage = $this->usdtpolygon_tolerance_percentage;
...
if ($paygatedottocryptogateway_usdtpolygon_genqrcode_conversion_resp && isset($paygatedottocryptogateway_usdtpolygon_genqrcode_conversion_resp['qr_code'])) {
	...
	$order->add_meta_data('paygatedotto_usdtpolygon_tolerance_percentage', $paygatedottocryptogateway_usdtpolygon_tolerance_percentage, true);
...
function paygatedottocryptogateway_usdtpolygon_change_order_status_callback( $request ) {
	...
	$paygatedottocryptogateway_usdtpolygonexpected_amount = $order->get_meta('paygatedotto_usdtpolygon_payin_amount', true) * $order->get_meta('paygatedotto_usdtpolygon_tolerance_percentage', true);
