...
protected $solsol_tolerance_percentage;
protected $icon_url;
    ...
    public function __construct() {
		...
		$this->solsol_tolerance_percentage = sanitize_text_field($this->get_option('solsol_tolerance_percentage'));
    ...
    public function init_form_fields() {
        $this->form_fields = array(
            ...
            'solsol_tolerance_percentage' => array(
    ...
    public function process_payment($order_id) {
		...
		$paygatedottocryptogateway_solsol_tolerance_percentage = $this->solsol_tolerance_percentage;
...
if ($paygatedottocryptogateway_solsol_genqrcode_conversion_resp && isset($paygatedottocryptogateway_solsol_genqrcode_conversion_resp['qr_code'])) {
	...
	$order->add_meta_data('paygatedotto_solsol_tolerance_percentage', $paygatedottocryptogateway_solsol_tolerance_percentage, true);
...
function paygatedottocryptogateway_add_instant_payment_gateway_solsol($gateways) {
    $gateways[] = 'PayGateDotTo_Crypto_Payment_Gateway_Solsol';
    return $gateways;
}
add_filter('woocommerce_payment_gateways', 'paygatedottocryptogateway_add_instant_payment_gateway_solsol');
}
...
function paygatedottocryptogateway_solsol_change_order_status_callback( $request ) {
	...
	$paygatedottocryptogateway_solsolexpected_amount = $order->get_meta('paygatedotto_solsol_payin_amount', true) * $order->get_meta('paygatedotto_solsol_tolerance_percentage', true);
